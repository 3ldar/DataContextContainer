...
namespace DataContextContainer.Migrations
{
    ...
    [Migration("20210206131925_CustomFilter")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataContextContainer.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DataContextContainer.Models.Filter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DataContextContainer.UserProduct", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DataContextContainer.UserProduct", b =>
                {
                    b.HasOne("DataContextContainer.Models.Product", "Product")
                        .WithOne()
                        .HasForeignKey("DataContextContainer.UserProduct", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
