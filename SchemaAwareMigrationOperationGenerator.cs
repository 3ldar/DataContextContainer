...
namespace Microsoft.EntityFrameworkCore.Migrations.Design
{
    ...
    public class SchemaAwareCSharpMigrationOperationGenerator : ICSharpMigrationOperationGenerator
    {
        private readonly ISchemaNameProvider schemaNameProvider;

        /// <summary>
        ///     Initializes a new instance of the <see cref="SchemaAwareCSharpMigrationOperationGenerator" /> class.
        /// </summary>
        /// <param name="dependencies"> The dependencies. </param>
        public SchemaAwareCSharpMigrationOperationGenerator(CSharpMigrationOperationGeneratorDependencies dependencies, ISchemaNameProvider schemaNameProvider)
        {
            Dependencies = dependencies;
            this.schemaNameProvider = schemaNameProvider;
            IndentedSringBuilderExtensions.IsPublic = schemaNameProvider.SchemaName == "public";
        }
        ...
        protected virtual void Generate(EnsureSchemaOperation operation, IndentedStringBuilder builder)
        {
            ...
            using (builder.Indent())
            {
                if (this.schemaNameProvider.SchemaName == "public")
                {
                    builder.Append(Code.Literal(operation.Name));
                }
                else
                {
                    builder.Append($"name: this.SchemaName");
                }
    ...
    public static class IndentedSringBuilderExtensions
    {
        private static readonly string SchemaNameProperty = "this.SchemaName";
        public static bool IsPublic { get; set; }

        public static void AddSchemaName(this IndentedStringBuilder builder, bool prefixOrPostfix = true)
        {
            if (prefixOrPostfix)
            {
                builder.AppendLine(",");
            ...
            {
                builder.Append(SchemaNameProperty);
            }
